...
export function Principles() {
  return (
    <section className="px-6 md:px-10 py-14 md:py-32 bg-ink text-parchment">
      <div className="mx-auto max-w-[1320px]">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-16">
          <div className="md:col-span-4 mb-2 md:mb-0">
            ...
            <Reveal delay={0.05}>
              <h2 className="display-tight text-[clamp(36px,5.5vw,72px)] text-parchment leading-[1] max-w-[14ch]">
                Four non-negotiables.
              </h2>
            </Reveal>
            <Reveal delay={0.12}>
              <p className="mt-5 md:mt-8 text-[15.5px] leading-[1.65] text-parchment/70 max-w-[44ch]">
          ...
          <ul className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-x-12 md:gap-y-12">
            {principles.map((p, i) => (
