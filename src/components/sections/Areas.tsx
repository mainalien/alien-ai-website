  ...
  return (
    <section className="px-6 md:px-10 py-24 md:py-32 bg-parchment">
      <div className="mx-auto max-w-[1320px]">
        ...
        <Reveal delay={0.05}>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 mb-14 md:mb-20 items-end">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 border-t border-l border-ink/10">
          {areas.map((a, i) => (
            <Reveal key={a.name} as="li" delay={0.03 + (i % 3) * 0.03}>
              <article className="flex flex-col gap-4 p-7 md:p-9 border-b border-r border-ink/10 h-full">
