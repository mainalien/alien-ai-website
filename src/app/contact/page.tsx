    ...
    <>
      <section className="px-6 md:px-10 pt-20 md:pt-28 pb-20">
        <div className="mx-auto max-w-[1320px] grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16">
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            <Reveal delay={0.05}>
              <h1 className="display-tight text-[clamp(56px,9vw,144px)] text-inkwell leading-[0.95] max-w-[14ch]">
            ...
            <Reveal delay={0.2}>
              <a
                ...
                className="inline-flex items-center justify-between gap-3 bg-inkwell text-parchment rounded-full pl-7 pr-3 py-3.5 text-[16px] md:text-[18px] font-medium no-underline hover:bg-terracotta-deep transition-colors group w-fit"
              >
                <span>aliens@alienai.llc</span>
                <span className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-parchment text-inkwell group-hover:text-terracotta-deep transition-colors">
                  →
                </span>
              </a>
            </Reveal>
          ...
          <aside className="lg:col-span-5">
            <Reveal delay={0.18}>
              <div className="rounded-2xl border border-inkwell/12 bg-linen/60 p-8 md:p-10">
                ...
                <dl className="flex flex-col divide-y divide-inkwell/10">
                  {expectations.map((f) => (
                    <div key={f.k} className="grid grid-cols-12 gap-4 py-4">
                      ...
                      <dd className="col-span-7 text-[14px] leading-[1.5] text-inkwell">
                        {f.v}
                      </dd>
                    </div>
                  ))}
      ...
      <section className="px-6 md:px-10 pb-32">
        <div className="mx-auto max-w-[1320px]">
          <div className="rounded-3xl bg-inkwell text-parchment p-10 md:p-16">
